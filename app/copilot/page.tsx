...
const prompts = ["Analyze my market", "What changed this month?", "Where are my biggest opportunities?", "Which territories are below target?", "Create an executive report"];
...
function CopilotContent() {
  ...
  async function ask(e?: FormEvent) {
    ...
    } catch (err: any) { setError(err?.message || "Copilot could not complete the request."); }
